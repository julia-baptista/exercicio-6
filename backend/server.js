...
io.on('connection', socket => {
  ...
  //   socket.join(privateRoom.toString())
  // });
  ...
  // socket.on('p0', ({ symbol, p0, privateRoom }) => {
  //   socket.to(privateRoom).broadcast.emit('updateP0', symbol)
  // });
  // inserir privateRomm em todos oa outros emits, inlcusive front-end
